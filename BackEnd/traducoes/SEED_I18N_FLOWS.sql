...
VALUES
  ...
  (NULL, 'pt-BR', 'flows', 'button.deleteSelectedBlock', 'Remover Bloco', 'Botão remover bloco selecionado'),
  ...
  (NULL, 'es-ES', 'flows', 'button.deleteSelectedBlock', 'Eliminar Bloque', 'Botón eliminar bloque seleccionado'),

...
VALUES
  ...
  (NULL, 'pt-BR', 'insights', 'kpi.rag.agents', '{{count}} decisões com fontes da base (RAG)', 'Texto uso RAG por decisão (legado)'),
  (NULL, 'pt-BR', 'insights', 'kpi.rag.decisions', '{{count}} decisões com uso da base (RAG)', 'Texto decisões com RAG'),
  ...
  (NULL, 'en-US', 'insights', 'kpi.rag.agents', '{{count}} decisions with knowledge-base sources (RAG)', 'Legacy RAG line'),
  (NULL, 'en-US', 'insights', 'kpi.rag.decisions', '{{count}} decisions using the knowledge base (RAG)', 'RAG decisions line'),
  ...
  (NULL, 'es-ES', 'insights', 'kpi.rag.agents', '{{count}} decisiones con fuentes de la base (RAG)', 'Texto RAG legado'),
  (NULL, 'es-ES', 'insights', 'kpi.rag.decisions', '{{count}} decisiones con uso de la base (RAG)', 'Texto decisiones RAG'),
  ...
  (NULL, 'pt-BR', 'insights', 'channels.distribution.description', 'Volume de decisões do agente por valor do campo channel (tb_agent_decisions), por período. Não é contagem de agentes.', 'Descrição gráfico distribuição'),
  ...
  (NULL, 'pt-BR', 'insights', 'channels.total', 'Decisões (soma)', 'Label total soma por canal'),
  ...
  (NULL, 'en-US', 'insights', 'channels.distribution.description', 'Volume of agent decisions grouped by the saved channel field (tb_agent_decisions) in the period. Not agent headcount.', 'Distribution chart description'),
  ...
  (NULL, 'en-US', 'insights', 'channels.total', 'Decisions (total)', 'Sum of per-channel counts'),
  ...
  (NULL, 'es-ES', 'insights', 'channels.distribution.description', 'Volumen de decisiones del agente por valor del campo channel (tb_agent_decisions) en el período. No es recuento de agentes.', 'Descripción gráfico distribución'),
  ...
  (NULL, 'es-ES', 'insights', 'channels.total', 'Decisiones (suma)', 'Etiqueta suma por canal'),

...
router.get('/packs/calendly-test', auth_middleware_1.requireAuth, templates_controller_1.getCalendlyTestPack);
router.get('/packs/flexible-scheduling', auth_middleware_1.requireAuth, templates_controller_1.getFlexibleSchedulingPack);
